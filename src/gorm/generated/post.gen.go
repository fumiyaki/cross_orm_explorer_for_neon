...
import (
	...
	"github.com/fumiyaki/cross_orm_explorer_for_neon/src/gorm/model"
)
...
func newPost(db *gorm.DB, opts ...gen.DOOption) post {
	...
	_post.CreatedAt = field.NewTime(tableName, "createdAt")
	_post.UpdatedAt = field.NewTime(tableName, "updatedAt")
	...
	_post.AuthorID = field.NewInt32(tableName, "authorId")
...
func (p *post) updateTableName(table string) *post {
	...
	p.AuthorID = field.NewInt32(table, "authorId")
...
func (p *post) fillFieldMap() {
	...
	p.fieldMap["authorId"] = p.AuthorID
}
